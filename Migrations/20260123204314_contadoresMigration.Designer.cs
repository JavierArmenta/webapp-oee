...
namespace WebApp.Migrations
{
    ...
    [Migration("20260123204314_contadoresMigration")]
    partial class contadoresMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Models.Linealytics.ContadorDispositivo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("TipoContador")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.HasIndex("MaquinaId", "Nombre")
                        .IsUnique()
                        .HasDatabaseName("IX_ContadoresDispositivo_MaquinaId_Nombre");

                    b.ToTable("ContadoresDispositivo", "linealytics");
                });
            ...
            modelBuilder.Entity("WebApp.Models.Linealytics.CorridaProduccion", b =>
                {
                    ...
                    b.Property<int>("ContadorDispositivoId")
                        .HasColumnType("integer");

                    b.Property<long>("ContadorFinal")
                        .HasColumnType("bigint");

                    b.Property<long>("ContadorInicial")
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("NumeroResets")
                        .HasColumnType("integer");

                    b.Property<long>("ProduccionTotal")
                        .HasColumnType("bigint");

                    b.Property<int?>("ProductoId")
                        .HasColumnType("integer");

                    b.Property<long>("UltimoContadorValor")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ContadorDispositivoId", "Estado")
                        .HasDatabaseName("IX_CorridasProduccion_ContadorId_Estado");

                    b.HasIndex("ContadorDispositivoId", "FechaInicio")
            ...
            modelBuilder.Entity("WebApp.Models.Linealytics.LecturaContadorNuevo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<long?>("ContadorAnterior")
                        .HasColumnType("bigint");

                    b.Property<int>("ContadorDispositivoId")
                        .HasColumnType("integer");

                    b.Property<long>("ContadorValor")
                        .HasColumnType("bigint");

                    b.Property<int>("CorridaId")
                        .HasColumnType("integer");

                    b.Property<long>("Diferencia")
                        .HasColumnType("bigint");

                    b.Property<bool>("EsReset")
                        .HasColumnType("boolean");

                    b.Property<bool>("EsRuido")
                        .HasColumnType("boolean");

                    b.Property<DateTime>("FechaHoraLectura")
                        .HasColumnType("timestamp with time zone");

                    b.Property<long>("ProduccionIncremental")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ContadorDispositivoId", "FechaHoraLectura")
                    ...
                    b.ToTable("LecturasContadorNuevo", "linealytics");
                });
            ...
            modelBuilder.Entity("WebApp.Models.Linealytics.ResumenProduccionDia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("NumeroCorridasCerradas")
                        .HasColumnType("integer");

                    b.Property<int>("NumeroCorridasIniciadas")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ContadorDispositivoId", "Fecha")
                        .IsUnique()
                        .HasDatabaseName("IX_ResumenesProduccionDia_ContadorId_Fecha");

                    b.ToTable("ResumenesProduccionDia", "linealytics");
                });

            modelBuilder.Entity("WebApp.Models.Linealytics.ResumenProduccionHora", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<long>("ContadorFin")
                        .HasColumnType("bigint");

                    b.Property<long>("ContadorInicio")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("ValorMaximo")
                        .HasColumnType("bigint");

                    b.Property<long>("ValorMinimo")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ContadorDispositivoId", "Fecha", "Hora")
                        .IsUnique()
                        .HasDatabaseName("IX_ResumenesProduccionHora_ContadorId_Fecha_Hora");

                    b.ToTable("ResumenesProduccionHora", "linealytics");
                });
            ...
            modelBuilder.Entity("WebApp.Models.Linealytics.CorridaProduccion", b =>
                {
                    b.HasOne("WebApp.Models.Linealytics.ContadorDispositivo", "ContadorDispositivo")
                        .WithMany("Corridas")
                        .HasForeignKey("ContadorDispositivoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("ContadorDispositivo");
